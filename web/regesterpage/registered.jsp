        ...
        <div class="logo_products">
            <div class="container">
                ...
                <div class="w3ls_logo_products_left">
                    <h1><a href="../products.jsp">super Market</a></h1>
                </div>
        ...
        <div class="breadcrumbs">
            <div class="container">
                <ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
                    <li><a href="../products.jsp"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>Home</a></li>
            ...
            <div class="container">
                ...
                <div class="login-form-grids">
                    ...
                    <form action="../SignUpServlet" method="post">
                        ...
                        <input type="text" placeholder="Jop..."  name="userJop" >
                        <br>
                        <input type="text" placeholder="Credit..."  name="userCredit" >
                        <br>
