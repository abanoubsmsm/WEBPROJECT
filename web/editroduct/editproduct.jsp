...
<!--===============================================================================================-->
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			...
			<form class="contact100-form validate-form"  method="POST" action="../HomeServlet" enctype="multipart/form-data" >
				...
				<div class="wrap-input100 validate-input bg1" data-validate="Please Type item Name">
					...
					<input class="input100" type="text" name="item_name" placeholder="Enter Item Name" value="<%=item.getItem_name()%>">
				</div>
				...
				<div class="wrap-input100 bg1 rs1-wrap-input100">
					...
					<input class="input100" type="text" name="qutity" placeholder="Enter Item Quantity" value="<%=item.getItem_quntity()%>">
				</div>
				
				<div class="wrap-input100 bg1 rs1-wrap-input100">
					<span class="label-input100">ITEM PRICE</span>
					<input class="input100" type="text" name="price" placeholder="Enter Item Price" value="<%=item.getItem_price()%>" >
				</div>
				...
				<div class="wrap-input100 validate-input bg1" data-validate="Please Type item Category">
					...
					<input class="input100" type="text" name="catagory" placeholder="Enter Item Category" value="<%=item.getItem_catagory()%>">
				</div>

				
				<input type="file" id="submitfile" name="pic" accept="image/*" src="" onchange="readURL(this);"><br><br>
